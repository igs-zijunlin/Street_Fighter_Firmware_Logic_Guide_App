...
const Sidebar = ({ isOpen, setIsOpen }: SidebarProps) => {
    ...
    return (
        <aside className={cn(
            "w-64 h-[100dvh] bg-white border-r border-slate-200 flex flex-col fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out md:translate-x-0 w-[280px] md:w-64 max-w-[85vw]",
                ...
                <div>
                    <div className="flex items-center gap-2 text-blue-600">
                        ...
                        <h1 className="text-xl font-bold tracking-wider" style={{ fontFamily: 'var(--font-cyber)' }}>
                            HADOUKEN <span className="text-slate-800">IO</span>
                        </h1>
                    </div>
